...
const checks = [
  ...
  ["src/client/controllers/WarshipSelectionController.ts", "this.game.hasOwner(clickRef)"],
  ["src/client/controllers/WarshipSelectionController.ts", "new ContextMenuEvent(event.x, event.y)"],
